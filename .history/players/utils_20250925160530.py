...
def generate_player():
    ...
    # If mid_range_shot is high, boost free throw
    if stats["mid_range_shot"] > 85:
        stats["free_throw"] = max(stats["free_throw"], stats["mid_range_shot"] - 5)

    # If driving layup or dunk is high, boost close shot
    ...
    # If offensive/defensive rebounding is high, boost strength
    ...
    s   tats["close_shot"] = max(stats["close_shot"], stats["post_moves"] - 5)
